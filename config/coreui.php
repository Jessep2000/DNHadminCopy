...
return [
     ...
     */
    'logo' => '<strong>DNHA</strong>dmin <i class="fas fa-anchor"></i>',
    'logo_mini' => '<strong>DNH</strong>',
    ...
    'menu' => [
        ...
        [
            'text' => 'Ships',          // The text to be displayed inside the menu.
            'url' => '/ships',     // The URL behind the text. Mutually exclusive with "route" option.
        ...
        [
            'text' => 'Accounts',          // The text to be displayed inside the menu.
            'url' => '/account',     // The URL behind the text. Mutually exclusive with "route" option.
            'icon' => 'chart-bar far',      // Name of FontAwesome icon to display. Note that you have to use the "far", "fas" or "fal" modifier behind the icon.
            'target' => '_self'            // Target attribute of <a> tag.
        ],
       [
           'text' => 'Yeartariffs',          // The text to be displayed inside the menu.
           'url' => '/yeartariffs',     // The URL behind the text. Mutually exclusive with "route" option.
           'icon' => 'chart-bar far',      // Name of FontAwesome icon to display. Note that you have to use the "far", "fas" or "fal" modifier behind the icon.
           'target' => '_self'            // Target attribute of <a> tag.
       ],
       [
        'text' => 'Budget',          // The text to be displayed inside the menu.
        'url' => '/budget',     // The URL behind the text. Mutually exclusive with "route" option.
        'icon' => 'chart-bar far',      // Name of FontAwesome icon to display. Note that you have to use the "far", "fas" or "fal" modifier behind the icon.
        'target' => '_self'            // Target attribute of <a> tag.
       ],
        [
